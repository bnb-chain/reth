    ...
    Evm: ConfigureEvm<Primitives = N> + 'static,
{
    ...
    fn compute_trie_input<TP: DBProvider + BlockNumReader>(
        ...
        debug!(
            ...
            convert_anchor_ms = convert_anchor_elapsed.as_millis() as u64,
            revert_ms = revert_elapsed.as_millis() as u64,
            append_ms = append_elapsed.as_millis() as u64,
            extend_ms = extend_elapsed.as_millis() as u64,
            total_ms = total_elapsed.as_millis() as u64,
            alloc_us = alloc_elapsed.as_micros() as u64,
            best_us = best_block_elapsed.as_micros() as u64,
            blocks_by_hash_us = blocks_by_hash_elapsed.as_micros() as u64,
            filter_us = filter_elapsed.as_micros() as u64,
            convert_anchor_us = convert_anchor_elapsed.as_micros() as u64,
            revert_us = revert_elapsed.as_micros() as u64,
            append_us = append_elapsed.as_micros() as u64,
            extend_us = extend_elapsed.as_micros() as u64,
