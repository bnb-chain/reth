    ...
    Evm: ConfigureEvm<Primitives = N> + 'static,
{
        ...
        V: PayloadValidator<T, Block = N::Block>,
    {
        ...
        let has_ancestors_with_missing_trie_updates =
            self.has_ancestors_with_missing_trie_updates(block.sealed_header(), ctx.state());
        ...
        let mut handle = if use_state_root_task {
            ...
            if trie_input.prefix_sets.is_empty() {
                ...
                info!(target: "engine::tree", block=?block_num_hash, "Disabling state root task due to non-empty prefix sets");
        ...
        self.metrics.engine.block_execution_duration.record(execution_elapsed.as_secs_f64());
        ...
        self.metrics.block_validation.record_state_root(&trie_output, root_elapsed.as_secs_f64(), false);
        ...
        self.metrics.engine.block_validation_duration.record(root_elapsed.as_secs_f64());
...
pub type ValidationOutcome<N, E = InsertBlockError<BlockTy<N>>> =
