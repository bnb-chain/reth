...
//     use reth_triedb_state_trie::{SecureTrieId, SecureTrieBuilder, SecureTrieTrait, account::StateAccount};
...
//     let mut reth_trie = SecureTrieBuilder::new(path_db)
//         .with_id(id)
//         .build()
//         .unwrap();

//     // Create BSC StateTrie instance
//     let mut bsc_trie = BscStateTrie::new(B256::ZERO, "/tmp/bsc_test_db").unwrap();

//     // Add to Reth trie
//     let account = StateAccount::default();

//     reth_trie.update_account(Address::ZERO, &account).unwrap();

//     // Add to BSC trie
//     bsc_trie.update_account(
//         Address::ZERO,
